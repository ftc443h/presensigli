    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title fs-2">Presensi</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card text-center h-100 shadow rounded-3">
                        ...
                        <div class="card-body py-4">
                            ...
                            @else
                                ...
                                <a href="{{ route('presensi-admin.masuk') }}" class="btn btn-primary fs-5 px-4">
                        ...
                        <div class="card-body py-4">
                            ...
                            @else
                                ...
                                @elseif ($cekPresensi && $cekPresensi->jam_masuk && !$cekPresensi->jam_keluar)
                                    ...
                                    <a href="{{ route('presensi-admin.keluar') }}" class="btn btn-danger fs-5 px-4">
