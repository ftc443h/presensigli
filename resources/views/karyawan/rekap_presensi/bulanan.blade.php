...
@section('content')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="filter-form">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="tahun" min="2000"
    ...
    <script>
        $(document).ready(function() {
            let table = $('#rp-bulanan-karyawan').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('rekap-bulanan.karyawan.data') }}',
                    data: function(d) {
                        d.bulan = $('#bulan').val();
                        d.tahun = $('#tahun').val();
                    }
            ...
            function exportData(format) {
                ...
                const baseRoutes = {
                    excel: '{{ route('rekap-bulanan.karyawan.export.excel') }}',
                    pdf: '{{ route('rekap-bulanan.karyawan.export.pdf') }}'
                };

                const url = `${baseRoutes[format]}?bulan=${bulan}&tahun=${tahun}`;
