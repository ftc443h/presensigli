                ...
                <div class="col-lg">
                    <div class="container-tight">
                        <div class="text-center mb-4">
                            <!-- BEGIN NAVBAR LOGO --><a href="{{ url('/') }}" class="navbar-brand navbar-brand-autodark"><svg xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68" class="navbar-brand-image">
                                    <path
                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <h2 class="h2 text-center mb-4">PT. Global Lintas Iramada</h2>
