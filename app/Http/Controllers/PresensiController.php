...
class PresensiController extends Controller
{
    ...
    /**
     * Menampilkan halaman presensi admin.
     */
    ...
    /**
     * Menampilkan halaman presensi masuk untuk admin.
     */
    public function presensiMasukCamAdmin()
    {
        try {
            // Ambil lokasi presensi berdasarkan nama lokasi dari karyawan yang sedang login
            $lokasi = LokasiPresensi::where(
            ...
            // Kembalikan view dengan data lokasi
            return view(
                'admin.presensi.presensi-masuk-cam',
                compact('lokasi')
            );
        } catch (\Throwable $th) {
            // Tangani error jika lokasi tidak ditemukan atau terjadi kesalahan lain
    ...
    /**
     * Proses presensi masuk untuk admin.
     */
    public function presensiMasukAdmin(Request $request)
    {
        try {
            $karyawan = Auth::user()->karyawan;
            $lokasi = LokasiPresensi::where(
    ...
    /**
     * Menampilkan halaman presensi keluar untuk admin.
     */
    public function presensiKeluarCamAdmin()
    {
        try {
            // Ambil lokasi presensi berdasarkan nama lokasi dari karyawan yang sedang login
            $lokasi = LokasiPresensi::where(
            ...
            // Kembalikan view dengan data lokasi
            return view(
                'admin.presensi.presensi-keluar-cam',
                compact('lokasi')
            );
        } catch (\Throwable $th) {
            // Tangani error jika lokasi tidak ditemukan atau terjadi kesalahan lain
    ...
    /**
     * Proses presensi keluar untuk admin.
     */
    public function presensiKeluarAdmin(Request $request)
    {
        try {
            $karyawan = Auth::user()->karyawan;
            $lokasi = LokasiPresensi::where(
